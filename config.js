// Alien Planet Defense v25 - CONFIG
// ------------------------------------------------------------
// v25 continues the Game backlog with the remaining mobile/support roster and
// the Bunker: Engineer, Scout, Sniper, Flamethrower Trooper, Combat Drone,
// Combat Ship, Mech, Sneaky Spotter and Mine Layer.
// ------------------------------------------------------------
const CONFIG={
  GAME:{STARTING_CREDITS:650,STARTING_METAL:160,STARTING_BASE_HP:300},
  WORLD:{WIDTH:10120,HEIGHT:7590,BASE_RADIUS:68,CAMERA_SPEED:1200,BASE_BUILD_CLEARANCE:2,BASE_TERRAIN_CLEARANCE:210},

  WORKERS:{COUNT:3},
  BUILD_TIME:{
    LASER:6.0,FLAME:5.0,BLOCKADE:3.0,SAFE_SPOT:3.5,MINE:7.0,ORE_MINE:7.0,REFINERY:9.0,LANDING_PAD:12.0,
    RAILGUN:9.0,TESLA:7.0,ANTI_AIR:5.5,CRYO:6.5,MORTAR:8.0,MINIGUN:6.5,MISSILE:9.0,DRONE_BAY:10.0,BUNKER:8.5
  },

  WALL:{COST_PER_100:11,HP_PER_100:320,THICKNESS:12,MIN_LENGTH:35,MAX_LENGTH:850,MAX_PATH_LENGTH:1500,PAINT_POINT_SPACING:45,BASE_BUILD_TIME:1.5,BUILD_TIME_PER_100:1.15},
  ...
  HEAVY_GUNNER:{COST:75,RANGE:190,MEMBERS:4,FIRE_INTERVAL:0.20,DAMAGE:1.10,MOVE_SPEED:155,HP:220},
  ROCKETEER:{COST:105,RANGE:290,MEMBERS:3,FIRE_INTERVAL:2.20,DAMAGE:13,SPLASH_RADIUS:58,MOVE_SPEED:150,HP:155},
  MEDIC:{COST:80,MEMBERS:3,HEAL_RANGE:165,HEAL_PER_SECOND:11,MOVE_SPEED:160,HP:140},
  ENGINEER:{COST:70,MEMBERS:3,MOVE_SPEED:165,HP:150,REPAIR_RANGE:120,REPAIR_PER_SECOND:18,CONSTRUCTION_BONUS:0.40},
  SCOUT:{COST:55,MEMBERS:4,RANGE:205,FIRE_INTERVAL:0.42,DAMAGE:1.25,BULLET_SPEED:820,MOVE_SPEED:245,HP:105,MARK_DURATION:2.2,MARK_DAMAGE_MULTIPLIER:1.15,DETECT_RANGE:360},
  SNIPER:{COST:95,MEMBERS:2,RANGE:445,FIRE_INTERVAL:2.05,DAMAGE:27,BULLET_SPEED:1200,MOVE_SPEED:145,HP:112},
  FLAME_TROOPER:{COST:90,MEMBERS:4,RANGE:130,FIRE_INTERVAL:0.18,DIRECT_DAMAGE:1.5,TARGETS:3,BURN_DURATION:2.4,MOVE_SPEED:145,HP:175},
  SPOTTER:{COST:95,MEMBERS:3,MOVE_SPEED:175,HP:90,SPOT_RANGE:375,MARK_DAMAGE_MULTIPLIER:1.20,MARK_REFRESH:0.32},
  MINE_LAYER:{COST:110,MEMBERS:3,MOVE_SPEED:155,HP:190,MINE_GOLD_COST:18,MAX_MINES_PER_UNIT:10,MINE_DAMAGE:95,MINE_SPLASH_RADIUS:58,MINE_TRIGGER_RADIUS:25},
  MECH:{COST:300,MOVE_SPEED:105,HP:680,RANGE:270,FIRE_INTERVAL:0.24,DAMAGE:8.5,BARRELS:2,BULLET_SPEED:880},
  COMBAT_DRONE:{COST:80,MOVE_SPEED:245,HP:95,RANGE:225,FIRE_INTERVAL:0.38,DAMAGE:4.3,BULLET_SPEED:920},
  COMBAT_SHIP:{COST:420,MOVE_SPEED:145,HP:420,RANGE:335,FIRE_INTERVAL:1.05,DAMAGE:22,SPLASH_RADIUS:34,MAX_ACTIVE:1},
  TRUCK:{COST:70,MOVE_SPEED:185,HP:135,CAPACITY:45,PICKUP_RANGE:100,UNLOAD_RANGE:100},
  BUNKER:{COST:220,HP:650,RADIUS:35,GARRISON_RANGE:90,RANGE_MULTIPLIER:1.28,DAMAGE_MULTIPLIER:1.35},
  ...
  PATHFINDING:{CELL_SIZE:48,MAX_VISITED:50000},
