// Alien Planet Defense v16 - CONFIG
// ------------------------------------------------------------
// v16 removes XP/cards and expands the logistics economy:
// gold from kills + crystal exports, metal from ore refining.
// Towers and walls use metal; units and buildings use gold.
// ------------------------------------------------------------
const CONFIG={
  ...
  WORKERS:{COUNT:3},
  BUILD_TIME:{LASER:6.0,FLAME:5.0,BLOCKADE:3.0,SAFE_SPOT:3.5,MINE:7.0,ORE_MINE:7.0,REFINERY:9.0,LANDING_PAD:12.0},
  ...
  // Tower COST values are METAL costs in v16.
  ...
  CRYSTALS:{
    ...
    // Compatibility values used only during the old core's pre-v16 bootstrap.
  ...
  TERRAIN:{
    ...
    // Bootstrap compatibility: the old generator runs once before v16 replaces it.
    MIN_OBSTACLES:0,EXTRA_OBSTACLES_RANDOM:0,MIN_RADIUS:24,MAX_RADIUS:50
  },

  // Kept only because the old engine initializes these fields before v16 patching.
